...
class BmsVmuSpDetailRms1:
    ...
    MESSAGE_ID = 2566850846 - 0x80000000
    NUM_BYTES = 8
...
class BmsVmuSpDetailRms2:
    ...
    MESSAGE_ID = 2566851102 - 0x80000000
    NUM_BYTES = 8
...
class BmsVmuSpDetailRms3:
    ...
    MESSAGE_ID = 2566851358 - 0x80000000
    NUM_BYTES = 8
...
class BmsVmuSpDetailRms4:
    ...
    MESSAGE_ID = 2566851614 - 0x80000000
    NUM_BYTES = 8
...
class BmsVmuSpDetailRms5:
    ...
    MESSAGE_ID = 2566851870 - 0x80000000
    NUM_BYTES = 4
